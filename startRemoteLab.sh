...
#Script for initialising the remote lab.
...
echo "starting remote lab"

curl -X POST -H "Content-Type: application/json" -d '{"stream":"video","destination":"wss://video.practable.io:443/in/dpr/video0","id":"0"}' http://localhost:8888/api/destinations

websocat tcp-listen:127.0.0.1:9999 ws://127.0.0.1:8888/ws/pendulum0 --text &
